...
from consts import EMPLOYEE_FILE_PATH, ATTENDANCE_FILE_PATH
from employee import Employee
from employee_manager import EmployeeManager


def main():
    employee_manager = EmployeeManager(EMPLOYEE_FILE_PATH)
    attendance_manager = AttendanceManager(ATTENDANCE_FILE_PATH)
    ...
    try:
        ...
        employee_manager.add_employee_manually_to_employees_file(employee1)
    except NameError:
        print("The employee that provided is not an employee here."
              " Please try to enter an employee again")
        raise

    print("input a new employee file:")
    new_path = str(input())
    new_employee_manager = EmployeeManager(new_path)
    new_employees = new_employee_manager.load_employees()
    ...
    employee_manager.add_employee_manually_from_file_to_employees_file(new_employees)
    ...
    try:
        ...
        # if the "employee card" is not exist,
        # the user is getting a message that he needs to add an existing employee.
        employee_manager.delete_employee_manually_from_employees_file(employee1)
    except NameError:
        print("The employee that provided is not an employee here."
              " Please try to enter an employee again")
    ...
    # nothing will happen.
    employee_manager.delete_an_employee_in_employees_file_from_a_file(new_employees)
    ...
    try:
        ...
        attendance_manager.log_enter(employee1.id)
    except TypeError:
    ...
    try:
        ...
        # a message will say - you need to provide an id.
        print(attendance_manager.attendance_report_of_an_employee(employee1.id))
    except TypeError:
        print("You did not provide your id!, Try again.")
    ...
    print(attendance_manager.attendance_report_of_month(11, 2020))
    ...
    print(attendance_manager.attendance_report_for_late_employees(9, 30, 2020))
